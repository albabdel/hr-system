...
async function POST(req) {
    ...
    const tenantId = req.headers.get("x-tenant-id")?.toLowerCase() || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveTenantId"])();
    ...
    if (!user?.passwordHash) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: {
    ...
    const ok = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(password, user.passwordHash);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5db24d0._.js.map