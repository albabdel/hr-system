...
const addEmployeeSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    firstName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(2, 'First name must be at least 2 characters.'),
    lastName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(2, 'Last name must be at least 2 characters.'),
...
function EmployeesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EmployeesPage.useEffect": ()=>{
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])('/api/employees').then({
                "EmployeesPage.useEffect": (data)=>{
                    setEmployees(data.map(formatEmployeeData));
                }
            }["EmployeesPage.useEffect"]).catch({
                "EmployeesPage.useEffect": ()=>{
                    toast({
                        title: 'Error',
            ...
            }["EmployeesPage.useEffect"]).finally({
                "EmployeesPage.useEffect": ()=>{
                    setLoading(false);
                }
            }["EmployeesPage.useEffect"]);
    ...
    const handleAddEmployee = async (newEmployeeData)=>{
        try {
            const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])('/api/employees', {
                method: 'POST',
                body: JSON.stringify({
    ...
    const handleDeleteConfirm = async ()=>{
        if (selectedEmployee) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/api/employees/${selectedEmployee.id}`, {
                    method: 'DELETE'
                });
...
_s(EmployeesPage, "nnMD1MSGURekBdk/E/w93tPWNP8=", false, function() {
    return [
...
//# sourceMappingURL=src_9d858d18._.js.map