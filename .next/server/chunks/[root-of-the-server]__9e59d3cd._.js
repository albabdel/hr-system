...
"[project]/.next-internal/server/app/api/tenant/status/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
;
function getSession() {
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])().get("vrs_token")?.value;
    if (!token) return null;
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyJwt"])(token);
    } catch  {
        return null;
    }
}
...
"[project]/src/lib/tenant.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function resolveTenantId(host, headerTenant) {
...
"[project]/src/app/api/tenant/status/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/tenant.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    ...
    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSession"])();
    // If there's a session, use its tenantId
    if (s) {
        const t = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(s.tenantId).lean();
        if (!t) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: {
    ...
    const tenantId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveTenantId"])(host);
    const t = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(tenantId).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e59d3cd._.js.map